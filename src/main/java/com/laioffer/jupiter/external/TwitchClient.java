...
public class TwitchClient {
    private static final String TOKEN = "Bearer 7nnk24dll1cjxkqsekfvb7l4t6r7w2";
    private static final String CLIENT_ID = "jlfycrfcsp0x9sn0x1ic5ddx6ive1b";
    ...
    private String buildGameURL(String url, String gameName, int limit) {
        if (gameName.equals("")) {
            ...
            try {
                ...
                // ENCODE special character, such as space. among us -> among%20us
    ...
    public List<Item> searchStreams(String gameId, int limit) throws TwitchException {
        List<Item> itemList = getItemList(searchTwitch(buildSearchURL(STREAM_SEARCH_URL_TEMPLATE, gameId, limit)));
