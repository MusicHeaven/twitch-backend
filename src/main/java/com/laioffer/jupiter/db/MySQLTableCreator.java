...
public class MySQLTableCreator {
    ...
    // the main function can run independently, other classes run based on Tomcat, this one don't need to
    public static void main(String[] args) {
        try {
            ...
            // newInstance can be eliminated after JAVA 8
            ...
            // executeUpdate used in Write or Update
            // executeQuery used in Read
            ...
            // opposite order of deleting, create the one be pointed to by foreign key
            ...
            statement.executeUpdate(sql);
            // password is encoded, protect customer data
